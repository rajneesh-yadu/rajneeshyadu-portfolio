export default function Card(props) {
  return (
    <>
      <div className='shadow-2xl rounded-md flex flex-col gap-2 items-center xl:w-4/6  text-4xl group  bg1-gradient-to-r from-secondary1-light via-secondary1-medium to-secondary1-dark'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex justify-evenly'>
            <div className='text-xl font-mono text-gray-600 w-5/6'>
              {props.price.map((item) => item + ' ')}
            </div>
            <div className='flex flex-col gap-2 justify-evenly mb-2'>
              <div className='text-primary1-light h-6 w-6'>
                <svg
                  aria-hidden='true'
                  focusable='false'
                  data-prefix='fas'
              ...
              {/* <div className='text-primary1-light h-6 w-6'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 496 512'
                  className='w-6 h-6 text-primary1-light '
                >
                  <path
                    fill='currentColor'
